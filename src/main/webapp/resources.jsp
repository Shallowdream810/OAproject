...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='resources-add.jsp';" value='添加菜单资源' />
 </td>
 </tr>
</table>
</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center"></td>
	<td align="center">/projectServlet</td>
	<td>启用</td>
	<td><a >删除</a> |<a href="resources-edit.jsp">编辑</a> </td>
</tr>
