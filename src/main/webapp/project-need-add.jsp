...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type:"get",
                url:"<%=bath%>/pro/jesonListInNeed",
                success:function (msg) {
                    $(msg).each(function (index,item) {
                        $("#projectname").append("<option value='"+item.pid+":"+item.pname+"'>"+item.pname+"</option>")
                    })
                }
            })
        })
...
<form id="forms" name="form2" action="ana/saveInfo" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="projectname" name="proname" onchange="change()">
